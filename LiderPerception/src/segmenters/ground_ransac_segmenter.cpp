 ...
 */
#include "../../include/segmenters/ground_ransac_segmenter.hpp"
...
void GroundRANSACSegmenter::segment(
	...
	std::cout << "Starting Ground RANSAC segmentation." << std::endl;
    ...
    *cloud = cloud_in;
	...
	std::cout << "Ground RANSAC segmentation complete. Took " << fp_ms.count() << "ms\n";
}
