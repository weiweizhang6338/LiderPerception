 ...
 */
#include "../../include/segmenters/ground_plane_fitting_segmenter.hpp"

#include <pcl/filters/extract_indices.h>  // pcl::ExtractIndices
#include <pcl/io/io.h>                    // pcl::copyPointCloud

#include "../../include/common/common.hpp"  // common::sortByAxisZAsc
...
void GroundPlaneFittingSegmenter::segment(
	...
	std::cout << "Ground Plane Fitting segmentation complete. Took " << fp_ms.count() << "ms\n";
}
