 ...
 */
#include "../../include/segmenters/region_euclidean_segmenter.hpp"

#include "../../include/common/bounding_box.hpp"
#include "../../include/common/geometry.hpp"  // common::geometry::calcCylinderDist
#include "../../include/object_builders/object_builder_manager.hpp"  // object_builder::createObjectBuilder()
...
void RegionEuclideanSegmenter::segment(
	...
	std::cout << "Starting Region Euclidean segmentation." << std::endl;
